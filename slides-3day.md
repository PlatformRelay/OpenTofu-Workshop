...
---
# DAY1-FIT: COMPRESS S00 40→25 (-15); preflight setup, retain orientation + first apply.
...
---
# DAY1-FIT: COMPRESS S01 55→30 (-25); fork timeline pre-read, retain why IaC + design principles + differentiators teaser + migration beat + alternatives + governance.
...
---
# DAY1-FIT: COMPRESS S07 60→50 (-10); retain local modules, demo registry/OCI lookup.
...
---
# DAY1-FIT: KEEP S08 65 min; flagship synthesis and learner proof remain intact.
...
---
# DAY1-FIT: SKIP S11 (-35); optional and already hidden with hide:true.
