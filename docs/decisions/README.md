...
Short records of decisions that shape this workshop. One file per decision,
`NNNN-title.md`, numbered sequentially. Format: Status · Context · Decision ·
Consequences.

| # | Title | Status |
| --- | --- | --- |
| [0001](./0001-animation-and-icons.md) | Animation & icon technology | Accepted |
| [0002](./0002-repository-and-content-structure.md) | Repository & content structure | Accepted |
| [0003](./0003-deck-composition.md) | Deck composition — superset & boil-down | Accepted |
| [0004](./0004-labelling-convention.md) | Labelling convention | Accepted |
