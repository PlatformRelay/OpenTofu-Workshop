...
| --- | --- | --- | --- | --- | --- |
| [`day-1/00-setup.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/00-setup.md) | S00 Welcome & setup | `localstack ✓` · `local ✓ (no docker)` | Docker or k8s LocalStack route | OpenTofu ≥1.9; LocalStack `:4566` | `unrun` |
| [`day-1/01-iac-fork.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/01-iac-fork.md) | S01 Infrastructure as Code | `mock ✓ (no docker)` | None | `local` + `random` providers | `unrun` |
| [`day-1/02-hcl-blocks.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/02-hcl-blocks.md) | S02 HCL & building blocks | `mock ✓ (no docker)` | None | `local` + `random` providers | `unrun` |
| [`day-1/03-core-workflow.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/03-core-workflow.md) | S03 The core workflow | `mock ✓ (no docker)` | None | `local` + `random` providers | `unrun` |
| [`day-1/06-variables.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/06-variables.md) | S06 Variables, validation & types | `mock ✓ (no docker)` | None | `local` + `random` providers | `unrun` |
| [`day-1/15-conditions-checks.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/15-conditions-checks.md) | S15 Validation, preconditions & checks | `mock ✓ (no docker)` | None | `local` + `random` providers | `unrun` |
| [`day-1/04-state.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/04-state.md) | S04 State | `mock ✓ (no docker)` · `localstack ✓ (Stretch)` | Docker for the S3-backend Stretch | `random` + `local` providers; Stretch: OpenTofu ≥1.10 (`use_lockfile`), LocalStack `:4566` | `unrun` |
| [`day-1/05-state-encryption.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/05-state-encryption.md) | S05 State encryption | `localstack ✓` · `mock ✓` | None for mock path; Docker for optional Step 6 (KMS) | `local` + `random` providers; pbkdf2 keys local, optional `aws_kms` via LocalStack `:4566` | `unrun` |
| [`day-1/07-modules.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/07-modules.md) | S07 Modules | `mock ✓ (no docker)` | None | `local` + `random` providers | `unrun` |
| [`day-1/08-naming-labels.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/08-naming-labels.md) | S08 Naming & labelling module | `localstack ✓` · `mock ✓` | Docker for Step 4 LocalStack path | `modules/naming`; LocalStack AWS provider | `unrun` |
| [`day-1/09-best-practices.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/09-best-practices.md) | S09 Best practices | `mock ✓ (no docker)` | None (`unzip` optional) | `local` + `archive` providers | `unrun` |
| [`day-1/10-differentiators.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-1/10-differentiators.md) | S10 OpenTofu differentiators | `localstack ✓` | Docker + LocalStack (`awslocal` via the container in Part B) | OpenTofu ≥1.9; `:4566` | `unrun` |
...
| [`day-2/19-testing-cicd.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-2/19-testing-cicd.md) | S19 Testing in CI/CD | `mock ✓ (paper + fixture · no docker)` | None | fixture YAML only | `unrun` |
| [`day-3/20-why-terramate.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-3/20-why-terramate.md) | S20 Why Terramate | `mock ✓ (no docker)` | **Terramate** CLI | Terramate ~0.17.x (spoilers) | `unrun` |
| [`day-3/21-stacks.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-3/21-stacks.md) | S21 Stacks | `mock ✓ (no docker)` (+ optional `localstack ✓`) | **Terramate** CLI | Terramate ~0.17.x | `unrun` |
| [`day-3/22-codegen.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-3/22-codegen.md) | S22 Code generation | `mock ✓ (no docker)` | **Terramate** CLI | Terramate ~0.17.x | `unrun` |
| [`day-3/23-orchestration.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-3/23-orchestration.md) | S23 Orchestration & ordering | `mock ✓ (no docker)` | **Terramate** CLI | Terramate ~0.17.x | `unrun` |
| [`day-3/24-change-detection.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-3/24-change-detection.md) | S24 Change detection & filtering | `mock ✓ (no docker)` | **Terramate** CLI | Terramate ~0.17.x | `unrun` |
| [`day-3/25-terramate-ci-cloud.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-3/25-terramate-ci-cloud.md) | S25 Terramate in CI + Cloud | `mock ✓ (paper + fixture · no docker)` | None | fixture YAML only | `unrun` |
| [`day-3/26-capstone.md`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/labs/day-3/26-capstone.md) | S26 Capstone & wrap-up | `localstack ✓` · `mock ✓` | Docker for Steps 5–6 (Part B build variant is mock-only) | capstone module + LocalStack; Part B reference `examples/capstone-build/` | `unrun` |
...
- **Beta feedback** — file gaps via [`.github/ISSUE_TEMPLATE/beta-feedback.yml`](https://github.com/PlatformRelay/OpenTofu-Workshop/blob/main/.github/ISSUE_TEMPLATE/beta-feedback.yml).
